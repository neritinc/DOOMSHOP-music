...
class Track extends Model
{
    ...
    private static function syncTracksCsv(): void
    {
        ...
        $lines = ['"id";"genre_id";"track_title";"bpm_value";"artist_id";"release_date";"track_length";"track_cover";"track_path"'];
        ...
        foreach ($rows as $row) {
            ...
            $lines[] = "\"{$id}\";\"{$genreId}\";\"{$title}\";\"{$bpm}\";\"{$artistId}\";\"{$releaseDate}\";\"{$trackLength}\";\"{$trackCover}\";\"{$trackPath}\"";
        }
