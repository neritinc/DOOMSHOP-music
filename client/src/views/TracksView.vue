    ...
    <form v-if="isAdmin" class="card card-body mb-3" @submit.prevent="createTrack">
      ...
      <div class="row g-2">
        ...
        <div class="col-md-3">
          ...
          <small class="text-muted">Select existing genres or type new ones.</small>
        ...
        <div class="col-md-3">
          ...
          <small class="text-muted">Select an existing artist or type a new one.</small>
      ...
      <div class="row g-2 mt-1">
        <div class="col-md-3">
          <label class="form-label mb-1">Megjelenés dátuma</label>
          <input v-model="form.release_date" class="form-control" type="date" />
        </div>
        <div class="col-md-3">
          <label class="form-label mb-1">Teljes hossz (mp)</label>
          <input
        ...
        <div class="col-md-3">
          <label class="form-label mb-1">Preview kezdete (mp)</label>
          <input
          ...
          />
          <small class="text-muted">Formátum: {{ formatTime(form.preview_start_at) }}</small>
        </div>
        <div class="col-md-3">
          <label class="form-label mb-1">Preview vége (mp)</label>
          <input
          ...
          />
          <small class="text-muted">Formátum: {{ formatTime(form.preview_end_at) }}</small>
        </div>
      </div>
      ...
      <div class="row g-2 mt-1">
        ...
        <div class="col-md-6">
          <label class="form-label fw-semibold">Cover image (drag & drop)</label>
          <div
      ...
      <button :disabled="submitting" class="btn btn-primary btn-sm mt-3 align-self-start">
...
export default {
  ...
  methods: {
    ...
    async load() {
      const [tracksRes, genresRes, artistsRes] = await Promise.all([
        service.list(),
        genreService.list(),
        artistService.list(),
      ]);
